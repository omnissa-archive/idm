...
# Use this script to update the certificate of your Identity Provider (i.e. Omnissa Identity Manager) in the keystore
# './src/main/resources/saml/samlKeystore.jks' file
# Run:
# $ ./src/main/resources/saml/update-certificate.sh


IDP_HOST=dev.omnissaidentity.asia
IDP_PORT=443
CERTIFICATE_FILE=omnissa-idm.cert
KEYSTORE_FILE=`dirname $0`/samlKeystore.jks
KEYSTORE_PASSWORD=secret
KEYSTORE_ALIAS=omnissaidm
